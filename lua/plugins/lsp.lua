return {
  ...
  vim.diagnostic.config {
    virtual_text = true, -- ← Esto muestra los errores en línea
    signs = true, -- ← Muestra los íconos en el signo de línea
    underline = true, -- ← Subraya texto con errores
    update_in_insert = false, -- ← Solo actualiza diagnósticos fuera de modo insert
